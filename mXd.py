...
class dragon:
    ...
    def __init__(self):
        self.image = load_image('Images/dragon.jpg')
...
class flames:
    ...
    def __init__(self):
        self.image = load_image('Images/fireball.jpg')
        self.imagerect = self.image.get_rect()
...
class maryo:
    ...
    def __init__(self):
        self.image = load_image('Images/mario.jpg')
        self.imagerect = self.image.get_rect()
...
endimage = load_image('Images/GameOver.jpg')
